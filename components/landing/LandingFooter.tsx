    ...
    <div className="marketing-container">
      <div className="marketing-footer-grid">
        <div className="marketing-footer-brand">
          <Link className="reference-lockup" href="/" aria-label="Lab Lords home"><PublicBrandLockup /></Link>
          <p>Simple management for libraries<br /> and the people who run them.</p>
          <span className="marketing-footer-tagline">Made for places where learning grows.</span>
