...
export async function getStudentSeatingSnapshot(
  ...
  // ⚡ Bolt: Replaced memory-heavy findMany + length with database-level distinct count
  // Impact: Reduces memory overhead from O(N) to O(1) and eliminates payload transfer.
